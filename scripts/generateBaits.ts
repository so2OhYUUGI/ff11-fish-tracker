...
function parseBaitDescriptionIds(filePath: string): Map<number, string> {
	...
	const baitDescriptions = new Map<number, string>();
...
function parseBaitsLua(itemsPath: string, baitDescriptions: Map<number, string>): BaitEntry[] {
